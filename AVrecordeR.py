...
class VideoRecorder():
  ...
  def __init__(self, fps):
    ...
    self.video_cap = cv2.VideoCapture(self.device_index)  # define my device camera to be used
...
#					timer_current = time.time() - timer_start
          time.sleep(0.16)  #to act as a dely between writing in the file and disply in the screen
...
def start_AVrecording(filename):
  ...
  global video_thread
  global audio_thread
  frame = int(input("Enter a number of frames: "))
  video_thread = VideoRecorder(frame)
...
if __name__== "__main__":
   ...
   option = int(input("Enter 1 for Video recording , 2 for video audio recording "))
   if option == 2:
